<template>
  <div>
    <Title class="flex justify-center mt-10" heading="安全验证"></Title>
    <div
    ...
    >
      ...
      <Input
        ...
        placeholder="谷歌验证码"
      />
      <Button class="w-full h-10 mt-12" @click="home">确认</Button>
      <h3 class="mt-6 text-bayshoreBlue text-base text-center">安全码丢失？</h3>
    </div>
  </div>
</template>
