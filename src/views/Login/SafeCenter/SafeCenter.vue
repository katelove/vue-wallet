    ...
    <BlueContainer title="" class="ml-8 mr-8 mt-10">
      ...
      <div class="pr-6 pl-6 pt-5 pb-5">
        <div class="flex justify-between">
          <p class="text-base">面容支付</p>
          <SwithBtn />
        </div>
        <div class="flex justify-between mt-6">
          <p class="text-base">支付二次验证</p>
          <SwithBtn />
        </div>
        <div class="flex justify-between mt-6">
          <p class="text-base">修改二次验证密码</p>
          <router-link to="/safeCenter/secondPwd"
            ><img
              class="h-full"
              src="@/assets/icon/arrow.png"
              style="width: 10px;height: 17px"
        ...
        <div class="flex justify-between mt-6">
          ...
          <router-link to="/safeCenter/setSecondPwd"
            ><img
              class="h-full"
              src="@/assets/icon/arrow.png"
              style="width: 10px;height: 17px"
      ...
      <div class="pr-6 pl-6 pt-5 pb-5">
        <div class="flex justify-between">
          ...
          <router-link to="/safeCenter/bindPhone"
            ><img
              class="h-full"
              src="@/assets/icon/arrow.png"
              style="width: 10px;height: 17px"
        ...
        <div class="flex justify-between mt-6">
          ...
          <p class="text-base">1234@gmail.com</p>
        </div>
        <div class="flex justify-between mt-6">
          <p class="text-base">谷歌验证</p>
          <router-link to="/safeCenter/bindGoogle"
            ><img
              class="h-full"
              src="@/assets/icon/arrow.png"
              style="width: 10px;height: 17px"
      ...
      <div class="pr-6 pl-6 pt-5 pb-5">
        <div class="flex justify-between">
          <p class="text-base">保持登录</p>
          <SwithBtn />
        </div>
        <div class="flex justify-between mt-6">
          <p class="text-base">面容解锁</p>
          <SwithBtn />
        </div>
        <div class="flex justify-between mt-6">
          <p class="text-base">手勢解锁</p>
          <SwithBtn />
        </div>
      </div>
      <div class="w-full bg-diamondGrey h-2"></div>
      <div class="p-6">
        <Button
          class="w-full h-10 bg-yewLime text-white"
